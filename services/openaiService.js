...
📝 ОЧЕНЬ ВАЖНОЕ ПРАВИЛО ДЛЯ ФОРМУЛ:
- Все математические выражения, уравнения, формулы должны быть оформлены в TeX-формате:
  • Строчные формулы: \\(ваша формула\\) или $ваша формула$
  • Вынесенные формулы: \\[ваша формула\\] или $$ваша формула$$
- Пример: "Реши уравнение: \\( x^2 + 5 = 0 \\)"
- Пример вынесенной формулы: 
  \\[ 
    \\int_0^1 x^2 \\, dx 
  \\]
- Никогда не используй **жирный текст** для формул!
`;
